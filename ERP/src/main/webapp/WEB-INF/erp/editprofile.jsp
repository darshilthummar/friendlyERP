							...
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form id="change_pass">
										<input type="hidden" class="form-control" id="id1" name="id" value="${user.id}">
									...
									<div class="modal-footer">
								    	<button type="button" class="btn btn-primary submit_button" id="submit_button" onClick="validatePassword();">Submit</button>
