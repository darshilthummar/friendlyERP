											...
											<form class="m-form m-form--fit m-form--label-align-right">
												<div class="m-portlet__body">
													...
													<div class="form-group m-form__group row">
														...
														<div class="col-7">
															<input class="form-control m-input" type="text" value="Yash patel">
														</div>
													</div>
													<div class="form-group m-form__group row">
														<label for="example-text-input" class="col-2 col-form-label">
														...
														<div class="col-7">
															<input class="form-control m-input" type="text" value="CEO">
														</div>
													</div>
													<div class="form-group m-form__group row">
														<label for="example-text-input" class="col-2 col-form-label">
														...
														<div class="col-7">
															<input class="form-control m-input" type="text" value="Greencrop">
													...
													<div class="form-group m-form__group row">
														...
														<div class="col-7">
															<input class="form-control m-input" type="text" value="+91 99784 45563‬">
														</div>
													</div>
